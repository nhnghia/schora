 ...
 * <ul>
 *   <li>{@link fr.lri.schora.expr.impl.IntegerImpl#getValue <em>Value</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class IntegerImpl extends ConstanceImpl implements fr.lri.schora.expr.Integer {
	/**
	...
	public void setValue(int newValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ExprPackage.INTEGER__VALUE, oldValue, value));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ExprPackage.INTEGER__VALUE:
				return getValue();
		}
