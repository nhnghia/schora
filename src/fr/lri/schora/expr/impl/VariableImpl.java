 ...
 * <ul>
 *   <li>{@link fr.lri.schora.expr.impl.VariableImpl#getName <em>Name</em>}</li>
 *   <li>{@link fr.lri.schora.expr.impl.VariableImpl#getType <em>Type</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class VariableImpl extends ExpressionImpl implements Variable {
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ExprPackage.VARIABLE__NAME, oldName, name));
	}
	...
	public void setType(String newType) {
		...
		type = newType;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ExprPackage.VARIABLE__TYPE, oldType, type));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ExprPackage.VARIABLE__NAME:
				return getName();
			case ExprPackage.VARIABLE__TYPE:
				return getType();
		}
